...
const Blobs = ({ variant = "a" }) => (
    <div className={`pprint-blobs pprint-blobs-${variant}`} aria-hidden="true">
        <span className="pprint-blob pprint-blob-1" />
        <span className="pprint-blob pprint-blob-2" />
    </div>
);
...
const PrepPrint = () => {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            mm.add("(prefers-reduced-motion: no-preference)", () => {
                ...
                gsap.to(".pprint-hero-grid", {
                    yPercent: 22,
                    ease: "none",
                    scrollTrigger: { trigger: ".pprint-hero", start: "top top", end: "bottom top", scrub: true },
                });

                gsap.utils.toArray(".pprint-blob").forEach((blob, i) => {
                    gsap.to(blob, {
                        x: i % 2 === 0 ? 40 : -30,
                        y: i % 2 === 0 ? -30 : 40,
                        duration: 8 + i * 2,
    ...
    return (
        <div className="pprint-page" ref={pageRef}>
            ...
            <section className="pprint-section pprint-section-dark">
                <Blobs variant="dark" />
                <div className="pprint-container">
                    <div className="pprint-spotlight">
                        <div className="pprint-spotlight-copy reveal">
                            <span className="pprint-kicker kicker-light">{whatsappOrder.kicker}</span>
                            <h2 className="pprint-h2 on-dark"><Highlighted text={whatsappOrder.title} part={whatsappOrder.accent} /></h2>
                            <p className="pprint-section-sub on-dark">{whatsappOrder.subtitle}</p>
                        </div>
                        <div className="pprint-spotlight-visual pprint-tilt reveal">
                            <WhatsAppOrderMockup />
                        </div>
            ...
            <section className="pprint-section pprint-section-dark pprint-fit">
                <Blobs variant="dark" />
                <div className="pprint-container">
                    <div className="pprint-section-head reveal">
                        <span className="pprint-kicker kicker-light">{threeAppsIntro.kicker}</span>
                        <h2 className="pprint-h2 on-dark">
            ...
            <section className="pprint-section pprint-section-dark pprint-fit">
                ...
                <div className="pprint-container">
                    <div className="pprint-section-head reveal">
                        <span className="pprint-kicker kicker-light">Whitelabel &amp; multi-branch</span>
                        <h2 className="pprint-h2 on-dark">This isn't our platform with your logo. <em>It's your print shop's platform, built by us.</em></h2>
            ...
            <section className="pprint-section pprint-section-dark pprint-fit">
                ...
                <div className="pprint-container">
                    <div className="pprint-section-head reveal">
                        <span className="pprint-kicker kicker-light">Why Prepseed</span>
                        <h2 className="pprint-h2 on-dark">Proven at scale, <em>built to be yours.</em></h2>
                        <p className="pprint-section-sub on-dark">
            ...
            {/* FINAL CTA */}
            <section className="pprint-final-cta pprint-fit">
                <div className="pprint-hero-grid" />
                <Blobs variant="dark" />
                <div className="pprint-container">
                    <div className="pprint-final-inner reveal">
                        <span className="pprint-kicker kicker-light">Let's build your platform</span>
                        <h2 className="pprint-h2 on-dark">Your print shop platform. Your brand. <span className="pprint-accent">Live in weeks.</span></h2>
                        <p className="pprint-section-sub on-dark">
                            Book a walkthrough and we'll map PrepPrint's quoting, job tracking, billing and stock to
                            your branches, your presses and your brand.
                        </p>
                        <div className="pprint-hero-ctas">
                            <a href="tel:+919913382221" className="pprint-btn pprint-btn-primary">
                        ...
                        <div className="pprint-final-contact">
