      ...
      <div className="Container">
        <div className="flex-column-widthGap paddingTop maxWidth600">
          <h2 className="textCenter">
            Your Trusted Partner in Financial <span>Success</span>
          </h2>
          <p className="textCenter paraWeight">
            Built to empower your goals, streamline tasks, and give you full
            control over your finances, comprehensive tools tailored to meet all
        ...
        <div className="marginTop50 marginBottom50">
          <div className="AboutUsImageContainer">
            <img
              src="https://s3.ap-south-1.amazonaws.com/prepseed/prod/ldoc/media/AboutUsbanner.jpg"
              alt=""
            />
          </div>
        </div>
